...
const Contact = () => (
  <section id="contato" className="cta">
    <div className="cta__container">
      <span className="cta__label">Comece agora</span>
      <h2 className="cta__title">
        Pronto para sair do aluguel?
      </h2>
      <p className="cta__subtitle">
        A análise do seu perfil é <strong>100% gratuita</strong> e sem compromisso.
        Entre em contato agora e eu te mostro o caminho para a sua casa própria.
      </p>

      <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="cta__btn">
        <WppIcon />
        Falar com Clécio no WhatsApp
      </a>

      <a href="tel:+5583998642873" className="cta__phone">
        ou ligue: (83) 99864-2873
      </a>
